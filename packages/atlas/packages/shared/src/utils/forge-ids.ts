import type { CardType, CurioRarity } from "../types/forge.js";
...
const CURIO_RARITY_PREFIX: Record<CurioRarity, string> = {
  Common: "COM",
  Rare: "RAR",
  Legendary: "LEG",
  Corrupted: "COR",
...
export function formatCurioId(rarity: CurioRarity, n: number) {
