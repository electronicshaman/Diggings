...
function FieldAssistButton({ onClick, isLoading, tooltip = 'Generate with AI' }: FieldAssistButtonProps) {
  return (
    <TooltipProvider>
      <Tooltip>
...
export function AssistedCreate() {
  ...
  const handleGenerateHook = async () => {
    ...
    setGeneratingField('narrativeHook');
    ...
    try {
      ...
      if (result.content?.narrative_hook) {
