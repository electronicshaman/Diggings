...
func _get_fallback_path_for_reference(reference_key: String) -> String:
	var fallback_paths = {
		...
		"hand_area": "UI/Control/PlayAreasContainer/HandArea",
		"enemy_hand_area": "UI/Control/PlayAreasContainer/EnemyHandArea",
		"battlefield_area": "UI/Control/PlayAreasContainer/BattlefieldArea",
