...
func get_ui_reference_dictionary() -> Dictionary:
	...
	var ui_mappings = {
		"player_health": "%HealthLabel",
		"player_energy": "%EnergyLabel",
		"player_defense": "%DefenseLabel",
		"player_sanity": "%SanityLabel",
		"player_gold": "%GoldLabel",
		"class_resource": "%ClassResourceLabel",
		"character_name": "%CharacterNameLabel",
		"enemy_name": "%EnemyNameLabel",
		"enemy_health": "%EnemyHealthLabel",
		"enemy_defense": "%EnemyDefenseLabel",
		"enemy_status_container": "%EnemyStatusContainer",
		"deck_count": "%DeckCount",
		"deck_icon": "%DeckIcon",
		"discard_count": "%DiscardCount",
		"discard_icon": "%DiscardIcon",
		"removed_count": "%RemovedCount",
		"removed_icon": "%RemovedIcon",
		"turn": "%TurnLabel",
		"phase": "%PhaseLabel",
		"seed": "%SeedLabel",
...
func _get_fallback_path_for_reference(reference_key: String) -> String:
	var fallback_paths = {
		...
		"player_gold": "UI/Control/PlayerArea/PlayerStats/GoldLabel",
		"character_name": "UI/Control/PlayerArea/PlayerStats/CharacterNameLabel",
		"deck_count": "UI/Control/PileArea/DeckPile/DeckPileContent/DeckCount",
		"deck_icon": "UI/Control/PileArea/DeckPile/DeckPileContent/PileLayout/DeckIcon",
		"discard_count": "UI/Control/PileArea/DiscardPile/DiscardPileContent/DiscardCount",
		"discard_icon": "UI/Control/PileArea/DiscardPile/DiscardPileContent/PileLayout/DiscardIcon",
		"removed_count": "UI/Control/PileArea/RemovedPile/RemovedPileContent/RemovedCount",
		"removed_icon": "UI/Control/PileArea/RemovedPile/RemovedPileContent/PileLayout/RemovedIcon",
		...
		"enemy_status_container": "UI/Control/EnemyArea/EnemyStats/EnemyStatusContainer",
		"deck": "UI/Control/PileIndicatorsLeft/DeckLabel",
		"discard": "UI/Control/PileIndicatorsRight/DiscardLabel",
		"removed": "UI/Control/PileIndicatorsRight/RemovedLabel",
